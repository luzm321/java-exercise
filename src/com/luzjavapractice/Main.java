...
import java.util.ArrayList; // import ArrayList class in java.util package (similar to namespace)
//import java.util.*;
import java.util.Arrays; // package that has method overloading such as to print an array in string format
